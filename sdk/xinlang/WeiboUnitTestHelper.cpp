...
//#define APP_KEY "4070004062"
//#define APP_SECRET "bc33e3002accf2149124ede488e60548"
//#define REDIRECT_URL "http://apps.weibo.com/testaafuture"

//桌面客户端
#define APP_KEY "2293241697"	
#define APP_SECRET "17a5617eb50db4d2cfb3934988c71bee"
...
void WeiboTestCaseHelper::initializeParsingMap()
{
	...
	INSERT_PARSING_OBJECT (WBOPT_GET_STATUSES_SHOW,
		weibo::make_shared<ParsingStatus>());

	INSERT_PARSING_OBJECT (WBOPT_GET_STATUSES_SHOW_BATCH, 
		make_shared<ParsingStatusesList>("statuses"));

	INSERT_PARSING_OBJECT (WBOPT_GET_STATUSES_QUERYMID,
		weibo::make_shared<ParsingResult>(ParsingResult::ResultKeyList(1, "mid")));

	INSERT_PARSING_OBJECT (WBOPT_GET_STATUSES_QUERYID,
		weibo::make_shared<ParsingResult>(ParsingResult::ResultKeyList(1, "id")));
	...
	INSERT_PARSING_OBJECT_BATCH (WBOPT_POST_STATUSES_REPOST,
		WBOPT_POST_STATUSES_UPLOAD, weibo::make_shared<ParsingStatus>());
	...
	INSERT_PARSING_OBJECT_BATCH (WBOPT_POST_COMMENTS_CREATE,
		WBOPT_POST_COMMENTS_REPLY, weibo::make_shared<ParsingComment>());
	...
	INSERT_PARSING_OBJECT (WBOPT_GET_DIRECTMESSAGES_IS_CAPABLE,
		weibo::make_shared<ParsingResult>(ParsingResult::ResultKeyList(1, "result")));

	INSERT_PARSING_OBJECT_BATCH (WBOPT_POST_DIRECTMESSAGES_NEW,
		WBOPT_POST_DIRECTMESSAGES_DESTORY, weibo::make_shared<ParsingDirectMessage>());
	...
	INSERT_PARSING_OBJECT (WBOPT_GET_ACCOUNT_PROFILE_BASIC,
		weibo::make_shared<ParsingAccount>());
	...
	INSERT_PARSING_OBJECT (WBOPT_GET_TAGS, 
		weibo::make_shared<ParsingTagsList>());

	INSERT_PARSING_OBJECT (WBOPT_GET_TRENDS,
		weibo::make_shared<ParsingTrendsList>());


	// parsing for id
	INSERT_PARSING_OBJECT (WBOPT_GET_ACCOUNT_GET_UID,
		weibo::make_shared<ParsingResult>(ParsingResult::ResultKeyList(1, "uid")));
}
