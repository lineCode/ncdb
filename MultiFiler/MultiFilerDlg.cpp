...
void CMultiFilerDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_FILELIST2, c_FileList2);
    //}}AFX_DATA_MAP
}
...
BEGIN_MESSAGE_MAP(CMultiFilerDlg, CDialog)
	...
	ON_NOTIFY(LVN_BEGINDRAG, IDC_FILELIST2, OnBegindragFilelist)
...
HIMAGELIST hImglist;
	...
	{
		c_FileList2.ModifyStyle(0, LVS_SHAREIMAGELISTS);

		c_FileList2.SetImageList(&m_imglist, LVSIL_SMALL);

		// Set up the list columns.

		c_FileList2.InsertColumn(0, _T("Filename"), LVCFMT_LEFT, 0, 0);
		c_FileList2.InsertColumn(1, _T("Type"), LVCFMT_LEFT, 0, 1);
		c_FileList2.InsertColumn(2, _T("Size"), LVCFMT_LEFT, 0, 2);

		c_FileList2.SetColumnWidth(0, LVSCW_AUTOSIZE_USEHEADER);
		c_FileList2.SetColumnWidth(1, LVSCW_AUTOSIZE_USEHEADER);
		c_FileList2.SetColumnWidth(2, LVSCW_AUTOSIZE_USEHEADER);
		c_FileList2.InsertItem(0, _T("3333"));
